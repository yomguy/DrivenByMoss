    ...
    protected void registerTriggerCommands ()
    {
        ...
        for (int index = 0; index < this.numMCUDevices; index++)
        {
            ...
            if (this.configuration.getDeviceType (index) == MCUDeviceType.MAIN)
            {
                ...
                this.addButton (surface, ButtonID.AUTOMATION_WRITE, "Write", new AutomationModeCommand<> (AutomationMode.TOUCH, this.model, surface), 0, MCUControlSurface.MCU_WRITE, () -> t.getAutomationWriteMode () == AutomationMode.TOUCH);
